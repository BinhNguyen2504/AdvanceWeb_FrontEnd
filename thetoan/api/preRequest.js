...
export const teacherGetPresentation = (id) =>
  API.get(`/presentation/mypresentation/${id}`);

export const getPresentationByPin = (pin) =>
  API.get(`/presentation/getbypin/${pin}`);

export const createGame = (body) =>
  API.post('http://localhost:5001/api/game/creategame', body);

export const updateRoom = (pin, status) =>
